...
if(!sby_js_exists) {
    ...
    (function($){
                                ...
                                if( sby_supports_video() ){
                                    ...
                                    if (feed.settings.consentGiven && this.album[this.currentImageIndex].video.length){
                                        ...
                                        if (typeof window.sbyLightboxPlayer === 'undefined') {
                                            var args = {
                                                host: window.location.protocol + feed.embedURL,                                                videoId: videoID,
                                                playerVars: {
                                                    modestbranding: 1,
                                                    rel: 0,
                                                    autoplay: autoplay
                                        ...
                                        // remove all other play icon link
                                        jQuery('.sby_gdpr_notice_play_icon').remove();
                                        // add new play icon link
                                        jQuery(".sby_lb-container").prepend('<a href="https://www.youtube.com/watch?v='+this.album[this.currentImageIndex].video+'" target="_blank" rel="noopener noreferrer" class="sby_gdpr_notice sby_gdpr_notice_play_icon"><svg style="color: rgba(255,255,255,1)" class="svg-inline--fa fa-play fa-w-14 sby_playbtn" aria-label="Play" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="play" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z"></path></svg></a>');
                                    }
        ...
        function SbyFeed(el, index, settings) {
            ...
            this.embedURL = settings.allowCookies ? '//www.youtube.com' : '//www.youtube-nocookie.com';
        }
        ...
        SbyFeed.prototype = {
            ...
            initGalleryLayout: function() {
                ...
                if ($self.hasClass('sby_layout_gallery') && $self.find('.sby_player_outer_wrap').length) {
                    this.maybeRaiseSingleImageResolution($self.find('.sby_player_outer_wrap'), true);
            ...
            revealNewImages: function() {
                ...
                $self.find('.sby_item.sby_new').each(function () {
                ...
                setTimeout(function () {
                    ...
                    $self.find('.sby_transition').each(function() {
            ...
            afterSendCheckWPPostsToServer: function () {
